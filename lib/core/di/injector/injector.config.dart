...
import '../../../features/auth/domain/use_case/register_use_case.dart' as _i20;
...
import '../../../features/home/domain/use_case/logout_use_case.dart' as _i13;
import '../../../features/home/presentation/bloc/home_cubit.dart' as _i18;
...
import '../cache_init/cache_init.dart' as _i24;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i18.HomeCubit>(() => _i18.HomeCubit(get<_i12.JobsUseCase>(),
      get<_i13.LogoutUseCase>(), get<_i15.ApplyUseCase>()));
  gh.factory<_i19.LoginUseCase>(
      () => _i19.LoginUseCase(get<_i16.AuthRepository>()));
  gh.factory<_i20.RegisterUseCase>(
      () => _i20.RegisterUseCase(get<_i16.AuthRepository>()));
  gh.factory<_i21.LoginCubit>(() => _i21.LoginCubit(get<_i19.LoginUseCase>()));
  gh.factory<_i22.RegisterCubit>(
      () => _i22.RegisterCubit(get<_i20.RegisterUseCase>()));
  return get;
}
