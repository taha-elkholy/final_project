...
import 'package:final_project/features/auth/data/data_source/remote/auth_api_service.dart';
import 'package:final_project/features/auth/data/mappers/login_mapper.dart';
import 'package:final_project/features/auth/data/mappers/register_mapper.dart';
import 'package:final_project/features/auth/data/mappers/user_mapper.dart';
...
class AuthRepoImpl extends AuthRepository {
  ...
  Future<Either<Failure, User>> login({required LoginParam loginParam}) async {
    ...
    try {
      ...
      _localService.saveUserId(userId: userModel.user.id).then((value) {
        debugPrint('login save userId: $value');
      });
  ...
  Future<Either<Failure, User>> register(
    ...
    try {
      ...
      _localService.saveUserId(userId: userModel.user.id).then((value) {
        debugPrint('register save userId: $value');
      });
      return right(userModel.user.fromModel);
    } catch (error) {
  ...
  Future<Either<Failure, String>> logout() async {
    ...
    if (token != null) {
      try {
        ...
        await _localService.deleteUserId();
